...
export const updateSEO = (config: SEOConfig) => {
  ...
  updateMetaTag('og:url', config.url || 'https://umfinance.pro/');
  ...
  updateMetaTag('twitter:url', config.url || 'https://umfinance.pro/');
  ...
  updateCanonicalURL(config.url || 'https://umfinance.pro/');
};
...
export const SEO_CONFIGS = {
  home: {
    ...
    image: 'https://umfinance.pro/og-image.jpg'
  },
  quiz: {
    ...
    url: 'https://umfinance.pro/quiz',
    image: 'https://umfinance.pro/quiz-og-image.jpg'
  },
  results: {
  ...
  contact: {
    ...
    url: 'https://umfinance.pro/contact',
    image: 'https://umfinance.pro/contact-og-image.jpg'
  },
  success: {
    ...
    url: 'https://umfinance.pro/success',
    image: 'https://umfinance.pro/success-og-image.jpg'
  }
};
